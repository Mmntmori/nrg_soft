...
class LinksList extends React.Component {
    ...
    render() {
        const articleElements = this.props.linksList.map((e, i) => {
            return (
                <div className="article-list__item article" key={e.id} id={e.id}>
                    ...
                    <button type="button" className={`article__like-btn ${e.isLiked ? 'article__like-btn--liked' : null}`} onClick={() => { this.props.likeArticle(i)}}>
                        {e.isLiked ? 'UNLIKE' : 'LIKE'}
                    </button>
                    <div className="article__delete-btn" onClick={() => { this.props.deleteArticle(i) }}>
        ...
        return (
            <div className="article-list" >
                ...
                {this.props.isRequesting ? <Preloader /> : null}
            </div>
        )
    }
